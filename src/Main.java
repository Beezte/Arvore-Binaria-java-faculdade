            ...
            try {
                ...
                switch (opc) {
                    ...
                    case 2:
                        ...
                        System.out.print("Valor " + valorRemover + " removido da árvore com sucesso!");
                        break;
                    case 3:
                ...
                System.out.println("Eei! Insira um número inteiro que seja válido");
                leia.next(); // isso faz limpar o buffer do scanner e evita um loop infinito bjs estrelados da tulla luana
            }
        }
    }
}